...
public class Menu {
    ...
    void test2() {
        var input = "aba";
        if (finiteAutomata.verify(input))
            System.out.println("Test 2: \"" + input + "\" is accepted");
        else
            System.out.println("Test 2: \"" + input + "\" is not accepted");
    }

    void test3() {
        var input = "";
        if (finiteAutomata.verify(input))
            System.out.println("Test 3: \"" + input + "\" is accepted");
        else
            System.out.println("Test 3: \"" + input + "\" is not accepted");
    }
    ...
    public void showMenu() {
        ...
        System.out.println("test3       - Verify the sequence \"\" (should not accept)");
